...
var Service = function () {
  ...
  _createClass(Service, [{
    key: 'decideServer',
    value: function decideServer(method) {
    ...
    value: function _find(params) {
      ...
      var server = this.decideServer('find');
    ...
    value: function _get(id, params) {
      var server = this.decideServer('get');
    ...
    value: function create(data, params) {
      ...
      var server = this.decideServer('create');
    ...
    value: function _patch(id, data, params) {
      var server = this.decideServer('patch');
      var options = _extends({ raw: this.raw }, this.computeSequelizeParam(params.sequelize, server));
    ...
    value: function update(id, data, params) {
      var server = this.decideServer('update');
      var options = _extends({ raw: this.raw }, this.computeSequelizeParam(params.sequelize, server));
    ...
    value: function remove(id, params) {
      ...
      var server = this.decideServer('remove');
